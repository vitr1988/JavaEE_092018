 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://soap.webservice.otus.ru/", wsdlLocation = "http://localhost:2304/JavaEE/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://soap.webservice.otus.ru/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2304/JavaEE/calculator?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://soap.webservice.otus.ru/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.webservice.otus.ru/", "CalculatorImplPort"), Calculator.class, features);
    }
